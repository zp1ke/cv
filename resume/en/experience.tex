...
%---------------------------------------------------------
  \cventry
    {\href{https://ecuafirma.com}{EcuaFirma}: Management system and PDF digital signature system.} % Project
...
%---------------------------------------------------------
  \cventry
    {\href{https://logistiksusa.com/}{Logistiks}: Logistics system with warehouse and inventory management.} % Project
    {} % Company
    {} % Location
