...
%---------------------------------------------------------
  \cventry
    {\href{https://ecuafirma.com}{EcuaFirma}: Sistema de gestión y firma digital de PDF.} % Project
...
%---------------------------------------------------------
  \cventry
    {\href{https://logistiksusa.com/}{Logistiks}: Sistema de logística con gestión de almacenes e inventario.} % Project
    {} % Company
    {} % Location
